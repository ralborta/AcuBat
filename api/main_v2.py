...
# VERSIÓN LIMPIA PARA TEST - main_v2.py
...
app = FastAPI(
    title="Backend Acubat V2",
    description="Sistema de gestión de productos con procesamiento de Excel y alertas inteligentes - VERSIÓN LIMPIA",
    version="2.0.0"
)
...
# Importar módulos de forma segura - IMPORTS ABSOLUTOS
try:
    ...
    logger.info("✅ Módulos completos cargados exitosamente en main_v2.py")
    print("✅ Módulos completos cargados exitosamente en main_v2.py")
